var egret = window.egret;
	...
	_proto._Group1_i = function () {
		...
		t.width = 640;
		t.x = 0;
		t.elementsContent = [this.logo_i(),this.fruit1_i(),this.fruit3_i(),this.fruit2_i(),this.fruit5_i(),this.fruit4_i()];
		return t;
	};
