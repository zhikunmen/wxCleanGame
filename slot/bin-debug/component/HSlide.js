...
(function (lhj) {
    var HSlide = (function (_super) {
        ...
        function HSlide(trackName, thumbName, thumbName_press, width, trackHighlightName, scale9, scale92) {
            ...
            _this.thumb = new lhj.GameButton([thumbName, thumbName_press]);
            ...
            _this.thumb.addEventListener(egret.TouchEvent.TOUCH_BEGIN, _this.onThumbTouch, _this);
            _this.track.addEventListener(egret.TouchEvent.TOUCH_TAP, _this.onTrackTouch, _this);
            return _this;
        }
        ...
        HSlide.prototype.dispose = function () {
            ...
            if (this.track) {
                lhj.ResUtil.removeFromParent(this.track);
            }
            this.track = null;
            if (this.thumb) {
                lhj.ResUtil.removeFromParent(this.thumb);
            }
            this.thumb = null;
            if (this.trackHighlight) {
                lhj.ResUtil.removeFromParent(this.trackHighlight);
            }
    ...
    lhj.HSlide = HSlide;
    __reflect(HSlide.prototype, "lhj.HSlide");
})(lhj || (lhj = {}));
