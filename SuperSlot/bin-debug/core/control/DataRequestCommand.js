...
(function (superslot) {
    var DataRequestCommand = (function (_super) {
        ...
        DataRequestCommand.prototype.execute = function (notification) {
            var socketProxy = this.facade.retrieveProxy(superslot.ServerProxy.NAME);
            superslot.ResUtil.trace("execute:", notification.getType());
    ...
    superslot.DataRequestCommand = DataRequestCommand;
    __reflect(DataRequestCommand.prototype, "superslot.DataRequestCommand");
})(superslot || (superslot = {}));
