...
**/
var superslotBC = (function () {
    function superslotBC() {
    }
    /**
    ...
    */
    superslotBC.addEvent = function (key, dispatch, event, func, useCapture, priority, useWeakReference) {
        if (useCapture === void 0) { useCapture = false; }
        if (priority === void 0) { priority = 0; }
        if (useWeakReference === void 0) { useWeakReference = false; }
        if (!dispatch || !key || !event || !func)
            console.error("添加事件监听参数缺少:", superslotBC.addEvent.arguments);
    ...
    * @param useWeakReference   是否弱引用
    */
    superslotBC.addOnceEvent = function (key, dispatch, event, func, useCapture, priority, useWeakReference) {
        if (useCapture === void 0) { useCapture = false; }
        if (priority === void 0) { priority = 0; }
        if (useWeakReference === void 0) { useWeakReference = false; }
    ...
    * @param useCapture 冒泡阶段
    */
    superslotBC.removeEvent = function (key, dispatch, event, func, useCapture) {
        ...
        var infos;
        var instances;
        var instances_lib = superslotBC.instanceslib;
        var type = 0;
        var prevkey;
        var instances_arr;
        var hasClear = true;
    ...
    * 已监听类作为索引分支存储监听队列
    */
    superslotBC.instanceslib = new SuperSlotDictionary();
    /**
    * 临时监听队列
    */
    superslotBC.instances = [];
    /**
    * 索引：使用监听时外面传递进来的this
    */
    superslotBC.KEY = 0;
    ...
    * 索引：监听广播所执行的函数
    */
    superslotBC.FUNCTION = 3;
    /**
    * 索引：冒泡阶段
    */
    superslotBC.USECAPTURE = 4;
    /**
    * 索引：监听收到广播的优先级
    */
    superslotBC.PRIORITY = 5;
    /**
    * 索引：是否弱引用
    */
    superslotBC.USEWEAKREFERENCE = 6;
    return superslotBC;
}());
__reflect(superslotBC.prototype, "superslotBC");
