...
(function (superslot) {
    var MenuItem = (function (_super) {
        ...
        function MenuItem(arr, labelArr, label, alwayDispatch) {
            ...
            _this._bitmap.texture = superslot.ResUtil.createTexture(_this._data[0]);
            _this.addChild(_this._bitmap);
            _this.touchEnabled = true;
            _this.gotoAndStop(1);
            superslotBC.addEvent(_this, _this, egret.TouchEvent.TOUCH_TAP, _this.onClick);
            if (label) {
                _this._labelTxt = superslot.ResUtil.createTextFeild(0xFFFFFF, egret.HorizontalAlign.CENTER, label, 34, 3, 20, 231);
        ...
        MenuItem.prototype.gotoAndStop = function (frame) {
            this._frame = frame;
            this._bitmap.texture = superslot.ResUtil.createTexture(this._data[frame - 1]);
            if (this._lableArr) {
                if (!this._label) {
                ...
                this._label.texture = superslot.ResUtil.createTexture(this._lableArr[frame - 1]);
    ...
    superslot.MenuItem = MenuItem;
    __reflect(MenuItem.prototype, "superslot.MenuItem");
})(superslot || (superslot = {}));
(function (superslot) {
    /**
* 滑动按钮类
...
*/
    ...
    superslot.ToggleSwitch = ToggleSwitch;
    __reflect(ToggleSwitch.prototype, "superslot.ToggleSwitch");
})(superslot || (superslot = {}));
