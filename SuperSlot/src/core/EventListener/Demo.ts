class Demo extends egret.DisplayObjectContainer {
    ...
    public constructor() {
        ...
        var dic: SuperSlotDictionary = new SuperSlotDictionary();
        ...
        superslotBC.addOnceEvent(this, this.dispatchSprite, egret.Event.ENTER_FRAME, this.onEnterFrameOnce);

        //创建和监听一个Timer事件
        var timer: egret.Timer = new egret.Timer(50);
        superslotBC.addEvent(this, timer, egret.TimerEvent.TIMER, this.onEnterTimer);
        timer.start();
    ...
    */
    public onEnterFrameOnce(event: egret.Event) {
        ...
        setTimeout(() => {
            //移除3个匿名代理函数
            superslotBC.removeEvent(this, this.dispatchSprite, egret.Event.ENTER_FRAME);
            console.log("3个匿名代理函数被移除事件了.");
            //新增加一个事件，100秒后一起移除.
            superslotBC.addEvent(this, this.dispatchSprite, egret.Event.ENTER_FRAME, SuperSlotDelegateUtil.create(this, this.onEnterFrame, "新来的！"));
